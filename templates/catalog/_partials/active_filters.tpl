    ...
    <div class="d-flex align-items-center px-2 py-1 bg-white border rounded">
      <ul class="list-inline mb-0">
        {foreach from=$activeFilters item="filter"}
          <li class="list-inline-item my-1 mr-1 bg-light py-1 px-2 border">
      ...
      <a href="{$clear_all_link}" data-search-url="{$clear_all_link}"
        class="rounded-0 btn btn-sm btn-light js-search-filters-clear-all ml-auto border">
        {l s='Reset all' d='Shop.Theme.Actions'}
      </a>
    </div>
  {/if}
</section>
