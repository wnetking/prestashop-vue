...
<script type="text/x-template" id="product-miniature-template">
  <article class="product-miniature js-product-miniature"
    @mouseover="isHover = document.documentElement.clientWidth > 992 ? true : false"
    @mouseleave="isHover = document.documentElement.clientWidth > 992 ? false : true"
    ...
    <div class="position-relative thumbnail-container">
      ...
      <div class="product-list-actions mb-2 d-flex justify-content-center">
        ...
        <b-btn :id="sharePopOverId" variant="outline-secondary" class="mr-2">
          <span class="sr-only">{l s='Share' d='Shop.Theme.Actions'}</span>
          <i class="fa fa-share-alt" aria-hidden="true"></i>
        </b-btn>

        <b-btn variant="outline-secondary" data-link-action="quickview" class="quick-view">
