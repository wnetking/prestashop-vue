      ...
      <div class="product-list-actions mb-2 d-flex justify-content-center">
        <form :action="urls.pages.cart" method="post" class="add-to-cart-or-refresh mr-2">
          ...
          <b-button
            ...
            v-if="product.availability === 'unavailable' || product.add_to_cart_url && !configuration.is_catalog || product.availability != 'last_remaining_items' && product.availability != 'available'"
