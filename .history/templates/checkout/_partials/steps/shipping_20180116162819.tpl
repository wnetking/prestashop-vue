...
{block name='step_content'}
  ...
  <div class="delivery-options-list">
    {if $delivery_options|count}
            ...
            {foreach from=$delivery_options item=carrier key=carrier_id}
              <div>
                <div class="delivery-option">
                  <label class="custom-control custom-radio mb-2 p-2 p-xl-3 bg-light border rounded">
                      <input
      ...
      <button type="submit" class="continue btn btn-secondary" name="confirmDeliveryOption" value="1">
