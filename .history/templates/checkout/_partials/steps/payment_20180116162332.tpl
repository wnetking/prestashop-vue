...
{block name='step_content'}
      ...
      {foreach from=$module_options item="option"}
        ...
        {if $option.additionalInformation}
          <div
            ...
            class="p-2 p-xl-3 bg-light border rounded js-additional-information {if $option.id != $selected_payment_option} ps-hidden {/if}"
          >
  ...
  <div id="payment-confirmation">
    <div class="ps-shown-by-js">
      <button class="btn btn-secondary mb-3" type="submit" {if !$selected_payment_option} disabled {/if}>
        {l s='Order with an obligation to pay' d='Shop.Theme.Actions'}
      </button>
      {if $show_final_summary}
        <article class="rounded border notification notification-danger js-alert-payment-conditions" role="alert" data-alert="danger">
          {l
