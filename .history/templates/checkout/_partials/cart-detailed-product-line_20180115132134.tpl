<div class="row">
  <div class="col-3">
    <b-img slot="aside" :src="product.cover.medium.url" blank-color="#ccc" alt="placeholder" />
  </div>
  ...
  <div class="col-9">
    ...
    <div class="d-flex">
      <b-form-input type="number" placeholder="Product" disabled :value="product.quantity"></b-form-input>
