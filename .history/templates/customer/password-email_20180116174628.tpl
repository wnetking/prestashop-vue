...
{block name='page_content_container'}
  <section id="content" class="page-content password-form">
    {block name='page_content'}
      <form class="bg-white border rounded p-3 p-xl-5" action="{block name='form_new_password_actionurl'}{$urls.pages.password}{/block}" method="post">
        ...
        {block name='form_new_password_form_fields'}
          <section class="form-fields mb-3">

            <label>
              <small class="mb-1">{l s='Email' d='Shop.Forms.Labels'}</small>
              <input
                class="form-control"
                type="email"
                name="email"
...
{block name='page_footer'}
  <div>
    <a class="btn btn-secondary" href="{$urls.pages.authentication}">
