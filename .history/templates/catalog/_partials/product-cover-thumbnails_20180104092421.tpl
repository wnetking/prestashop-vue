...
<div class="images-container d-flex align-items-start">
    ...
    <ul class="product-images list-unstyled">
      {* {foreach from=$product.images item=image} *}
        <li v-for="image in modules.productPageData.images">
          <img class="img-fluid" :src="image.medium.url"
  ...
  {block name='product_cover'}
    <div class="product-cover">
      <img class="img-fluid" :src="modules.productPageData.cover.bySize.medium_default.url"
      :alt="modules.productPageData.cover.legend" :title="modules.productPageData.cover.legend"
      :width="modules.productPageData.cover.bySize.medium_default.width" itemprop="image">
    </div>
  {/block}
</div>
