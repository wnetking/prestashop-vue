...
<div class="images-container position-relative"
      ...
      <div v-bar>
        <div>
          <b-img-lazy
            ...
            v-img:name
            v-img="{literal}{src: image.bySize.large_default.url, title: modules.productPageData.name }{/literal}"></b-img-lazy>
        </div>
      </div>
    </div>
  {/block}
  ...
  {block name='product_cover'}
    <div class="product-cover text-center bg-white border rounded">
      <b-img-lazy
        v-img:name
        v-img="{literal}{src: modules.productPageData.cover.bySize.large_default.url, title: modules.productPageData.name }{/literal}"
        {* v-img:src='modules.productPageData.cover.bySize.large_default.url' *}
        ...
        fluid-grow center blank-color="#ccc" itemprop="image"></b-img-lazy>
    </div>
  {/block}
</div>
