...
{if $product.show_price}
  <div class="product-prices">
    {block name='product_price'}
      <div class="product-price d-flex mb-2 {if $product.has_discount}has-discount{/if}" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
        ...
        <span class="mr-1 h6" itemprop="price" content="{$product.price_amount}">
          {$product.price}
        </span>
        {if $configuration.display_taxes_label}
        <small class="form-text text-muted mr-2">
