      ...
      <div v-bar>
        <div>
          <b-img-lazy
            ...
            {* v-img:src="image.bySize.large_default.url" *}
            v-img:name
            v-img="{literal}{src: image.bySize.large_default.url}{/literal}"
            />
        </div>
      </div>
    </div>
  ...
  {block name='product_cover'}
    <div class="product-cover text-center bg-white border rounded">
      <b-img-lazy
        v-img:name
        v-img:title=''
        v-img="{literal}{src: modules.productPageData.cover.bySize.large_default.url}{/literal}"
