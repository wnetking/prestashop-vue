 ...
 *}
<nav aria-label="breadcrumb" role="navigation" data-depth="{$breadcrumb.count}" v-if="page.body_classes['page-category'] || page.body_classes['page-product'] || page.body_classes['page-supplier'] ">
