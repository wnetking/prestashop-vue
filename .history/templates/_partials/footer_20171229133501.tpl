 ...
 *}
 <b-container>
  ...
  <div class="progress fixed-top border-0">
    <div class="progress-bar progress-bar-striped bg-info progress-bar-animated border-0" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
  </div>
</b-container>
<div>
