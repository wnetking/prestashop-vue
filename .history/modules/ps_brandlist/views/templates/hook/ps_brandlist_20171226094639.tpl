...
<div class="col-12">
  <h4 class="h1 products-section-title text-center mb-2 mb-xl-4">
  ...
  {assign var="man_products" value=Manufacturer:getProducts($idManufacturer,
        $idLang,
        $p,
        $n,) scope=scope}

  <div data-module-name="brands" data-module-data="{$brands|@json_encode}">
    {if $brands}
