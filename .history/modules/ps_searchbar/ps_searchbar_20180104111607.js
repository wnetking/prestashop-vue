...
$(document).ready(function () {
  ...
  function createTemplate (product) {
    'use strict'
    console.log(product.id_product + '-cart_default/' + product.link_rewrite + '.jpg')

    var temp = '<a class="py-2">' +
      '<div class="d-flex align-items-start">' +
      '<img src="' + prestashop.urls.img_prod_url + product.id_product + '-cart_default/' + product.link_rewrite + '.jpg' +
